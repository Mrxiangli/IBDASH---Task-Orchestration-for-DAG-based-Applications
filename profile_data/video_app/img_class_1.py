...
if __name__ =='__main__':
	...
	for i in range(1,3):
		file_name=f"test_1_of_3_frame_{i}_{args.count}.jpg"
		result_file=f"test_1_of_3_frame_{i}_result_{args.count}.txt"
		# file_name=f"test_1_of_3_frame_{i}_0.jpg"
		# result_file=f"test_1_of_3_frame_{i}_result_{rd.randint(1,10000)}.txt"
	...
	print("img_class_1: "+str((end-start)))
